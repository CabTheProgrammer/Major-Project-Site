...
<center><h2>Lesson 7:How to alter text in WhatsApp</h2>

<iframe  width= "900" height="600" src="lesson7.mp4"> </iframe>
...
<button class="button button2"><a href="lesson6.php">Go Back </a></button>

<button class="button button2"><a href="lesson8.php">Next </a></button>
