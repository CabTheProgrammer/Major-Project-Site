...
.button2:active {
  ...
  box-shadow: 0 5px #666;Elderlearn by CRSM
...
<iframe  width= "900" height="600" src="lesson1.mp4"> </iframe>
...
<button class="button button2"><a href="home.php">Go Back </a></button>

<button class="button button2"><a href="lesson2.php">Next </a></button>
