...
<center><h2>Lesson 9:How to text (iPhone tips)</h2>

<iframe  width= "900" height="600" src="lesson9.mp4"> </iframe>
...
<button class="button button2"><a href="lesson8.php">Go Back </a></button>

<button class="button button2"><a href="lesson10.php">Next </a></button>
