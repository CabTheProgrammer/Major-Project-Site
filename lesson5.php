...
<iframe  width= "900" height="600" src="lesson5.mp4"> </iframe>
...
<button class="button button2"><a href="lesson4.php">Go Back </a></button>

<button class="button button2"><a href="lesson6.php">Next </a></button>
