...
<center><h2>Lesson 10:How to use Zoom: Basics</h2>

<iframe  width= "900" height="600" src="lesson10.mp4"> </iframe>
...
<button class="button button2"><a href="lesson9.php">Go Back </a></button>

<button class="button button2"><a href="home.php">Next </a></button>
